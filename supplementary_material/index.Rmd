...
```{r Avida-instructions-No-operation-Table, echo=FALSE, fig.pos='H', fig.cap="**No-operation instructions.** Instructions used in this study that have no direct effects when executed."}
knitr::include_graphics("images/Avida_instructions_No-operation_Table.png")
```

```{r, Avida-instructions-Hardware-control-Table, echo=FALSE, fig.pos='H', fig.cap="**Hardware control instructions.** Instructions used in this study that control the reading/writing of the Avidian genome and handle memory."}
knitr::include_graphics("images/Avida_instructions_Hardware_control_Table.png")
```

```{r, Avida-instructions-Math-Table, echo=FALSE, fig.pos='H', fig.cap="**Math instructions.** Instructions used in this study that execute mathematical operations."}
knitr::include_graphics("images/Avida_instructions_Math_Table.png")
```

```{r, Avida-instructions-Interaction-Table, echo=FALSE, fig.pos='H', fig.cap="**Interaction instructions.** Instructions used in this study that enable communication and interaction among cells within a multicellular organism."}
knitr::include_graphics("images/Avida_instructions_Interaction_Table.png")
```

```{r, Avida-instructions-Biological-Table, echo=FALSE, fig.pos='H', fig.cap="**Biological instructions.** Instructions used in this study that underpin cellular differentiation, multicellular development, and reproduction."}
knitr::include_graphics("images/Avida_instructions_Biological_Table.png")
```
...
```{r, FML, echo=FALSE, fig.pos='H', fig.cap="**Biological instructions.** Instructions used in this study that underpin cellular differentiation, multicellular development, and reproduction."}
knitr::include_graphics("images/SI_Table_FML.png")
```
