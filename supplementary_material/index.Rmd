...
where $F \equiv$ \{NOT, NAND, AND, ORNOT, OR, ANDNOT, NOR, XOR, EQUALS\}, $N_i$ is the number of times function $i$ is performed, $FML_i$ is the mutagenic level of function $i$ (as specified in Table \@ref(tab:FML), and $FML_{AND}$ is the base $FML$ (i.e., the mutagenic level of the function AND). 
